...
def upsert_xml_ledgers(cur: Any, config: SyncConfig) -> int:
    cur.execute(
        ...
        SELECT
            ...
            l.`name_kana_export_value`, l.`name_kana_export_source`, l.`name_kana_export_reason`,
            l.`insurance_symbol_raw`, l.`insurance_symbol_match`,
            l.`insurance_symbol_export_value`, l.`insurance_symbol_export_source`, l.`insurance_symbol_export_reason`,
            l.`insurance_number_raw`, l.`insurance_number_match`,
            l.`insurance_number_export_value`, l.`insurance_number_export_source`, l.`insurance_number_export_reason`,
            l.`birthdate`, l.`gender_code`,
            l.`report_category_code`, l.`program_type_code`,
            l.`report_category_code`, l.`program_type_code`,
            l.`basic_info_status`, l.`basic_info_reason`,
            l.`insurer_number_source`, l.`insurer_number_completion_status`,
            l.`insurer_number_completion_reason`, l.`insurer_number_export_value`,
            l.`address_source`,
            l.`address_completion_status`, l.`address_completion_reason`,
            l.`address_completed_value`, l.`postal_code_completed_value`,
        ...
        ON DUPLICATE KEY UPDATE
            ...
            `name_kana_export_value` = VALUES(`name_kana_export_value`),
            `name_kana_export_source` = VALUES(`name_kana_export_source`),
            `name_kana_export_reason` = VALUES(`name_kana_export_reason`),
            `insurance_symbol_raw` = VALUES(`insurance_symbol_raw`),
            `insurance_symbol_match` = VALUES(`insurance_symbol_match`),
            `insurance_symbol_export_value` = VALUES(`insurance_symbol_export_value`),
            `insurance_symbol_export_source` = VALUES(`insurance_symbol_export_source`),
            `insurance_symbol_export_reason` = VALUES(`insurance_symbol_export_reason`),
            `insurance_number_raw` = VALUES(`insurance_number_raw`),
            `insurance_number_match` = VALUES(`insurance_number_match`),
            `insurance_number_export_value` = VALUES(`insurance_number_export_value`),
            `insurance_number_export_source` = VALUES(`insurance_number_export_source`),
            `insurance_number_export_reason` = VALUES(`insurance_number_export_reason`),
            ...
            `basic_info_status` = VALUES(`basic_info_status`),
            `basic_info_reason` = VALUES(`basic_info_reason`),
            `insurer_number_source` = VALUES(`insurer_number_source`),
            `insurer_number_completion_status` = VALUES(`insurer_number_completion_status`),
            `insurer_number_completion_reason` = VALUES(`insurer_number_completion_reason`),
            `insurer_number_export_value` = VALUES(`insurer_number_export_value`),
            `address_source` = VALUES(`address_source`),
            `address_completion_status` = VALUES(`address_completion_status`),
            `address_completion_reason` = VALUES(`address_completion_reason`),
            `address_completed_value` = VALUES(`address_completed_value`),
            `postal_code_completed_value` = VALUES(`postal_code_completed_value`),
