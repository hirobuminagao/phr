...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--list-name", help="Default is generated from event/exam_month/current timestamp.")
    ...
    parser.add_argument("--confirm", action="store_true", help="Compatibility option. Lists are READY by default.")
    parser.add_argument("--draft", action="store_true", help="Create the list as DRAFT instead of READY.")
