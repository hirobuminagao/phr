...
def write_major_candidate_csv(path: Path, rows: list[dict[str, Any]]) -> None:
    ...
    fieldnames = [
        ...
        "staging_name_kana_full_norm",
        "candidate_name_kana_full_norm",
        ...
        "staging_name_kanji_full_norm",
        "candidate_name_kanji_full_norm",
        "staging_birth",
        "candidate_birth",
        "staging_gender_code",
...
def build_major_candidate_log_row(
    *,
    ...
    return {
        ...
        "staging_name_kana_full_norm": staging_row.get("name_kana_full_norm"),
        "candidate_name_kana_full_norm": candidate.get("name_kana_full_norm") or candidate.get("name_kana_full"),
