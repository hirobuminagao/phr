CREATE TABLE `health_exam_result`.`xml_ledger` (
  ...
  KEY `idx_xml_ledger_xml_file_name` (`xml_file_name`),
  ...
  KEY `idx_xml_ledger_basic_info_status` (`basic_info_status`),
  KEY `idx_xml_ledger_insurer_number_completion_status` (`insurer_number_completion_status`),
  KEY `idx_xml_ledger_address_completion_status` (`address_completion_status`),
