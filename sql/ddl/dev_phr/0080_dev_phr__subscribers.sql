CREATE TABLE `dev_phr`.`subscribers` (
  ...
  `name_kana_family_match` varchar(190) DEFAULT NULL COMMENT '姓カナ（照合用）',
  `name_kana_middle_match` varchar(190) DEFAULT NULL COMMENT 'ミドルネームカナ（照合用）',
  `name_kana_given_match` varchar(190) DEFAULT NULL COMMENT '名カナ（照合用）',
  `name_kanji_family_match` varchar(190) DEFAULT NULL COMMENT '姓漢字（照合用）',
  `name_kanji_middle_match` varchar(190) DEFAULT NULL COMMENT 'ミドルネーム漢字（照合用）',
