...
CREATE TABLE `csv_mapping_lab`.`analysis_columns` (
  ...
  `candidate_target_kind` varchar(64) DEFAULT NULL COMMENT 'LEDGER_FIELD/EXAM_ITEM_VALUE/IGNORE/REVIEW/WATCH等',
  ...
  `decision_status` varchar(32) NOT NULL DEFAULT 'UNREVIEWED' COMMENT 'UNREVIEWED/ADOPT/IGNORE/NEEDS_CONFIRMATION/DEFERRED/WATCH',
