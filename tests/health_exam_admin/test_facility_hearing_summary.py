...
def test_build_hearing_judgement_summary_converts_oroku_codes_and_counts_ledgers() -> None:
    rows = [
        {"exam_ledger_id": 1, "namecode": "9D100163100000011", "raw_value": "1"},
        {"exam_ledger_id": 1, "namecode": "9D100163500000011", "raw_value": "1"},
        {"exam_ledger_id": 2, "namecode": "9D100163100000011", "raw_value": "1"},
        {"exam_ledger_id": 2, "namecode": "9D100163600000011", "raw_value": "2"},
        {"exam_ledger_id": 3, "namecode": "9D100163200000011", "raw_value": "9"},
    ]
...
def test_build_hearing_judgement_summary_ignores_blank_values() -> None:
    summary = build_hearing_judgement_summary(
        [{"exam_ledger_id": 1, "namecode": "9D100163100000011", "raw_value": ""}]
    )
