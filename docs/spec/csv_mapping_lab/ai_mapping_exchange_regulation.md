...
このZIPは、健診結果CSVの列解析結果をAIに渡し、CSV取込マッピング候補を返してもらうためのものです。

AIは、同梱された `analysis_prompt.json` を読み、列ごとのマッピング候補をJSONだけで返してください。
...
AIは、サンプル値を実在人物・実在情報として扱わないでください。
