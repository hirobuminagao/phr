...
fuzoku3.csv における項目単位の形式・条件・型（ST / INT / PQ / EVN / OBS 等）の整理は、すでに一度FIX済みとする。

- 1701〜1745 を含む集計系項目は FIX 済み
- 1616（実績評価情報）も含め FIX 済み
- CSV上に再表示・grepでヒットしても未FIX扱いに戻さない

今後は「項目の再検証」は行わず、
セクション単位（90020 など）の構造整理・対応付けのみを対象とする。
